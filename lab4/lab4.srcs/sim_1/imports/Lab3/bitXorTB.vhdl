...
architecture behavior of xorTB is
  ...
  constant B_vals : B_array := (B"1111_1111_1111_0100",
                                ...
                                B"0000_0000_0000_0000", 
                                B"1111_1111_1111_1111", 
                                B"1111_1111_1111_1110");  
                                
                                
                                
  constant mode_vals : mode_array := (B"110", 
                                      B"110", 
                                      B"110", 
                                      B"110", 
                                      B"110");
  ...
  constant Cout_vals : Cout_array := ('0','1','0','0','1');
  
  constant C_vals : C_array := (B"1111_1111_1110_0100",
                                B"1111_1111_1111_0111",  
                                B"0000_0000_0000_0000", 
                                B"0000_0000_0000_0000", 
