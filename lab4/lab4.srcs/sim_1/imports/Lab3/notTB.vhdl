...
architecture behavior of notTB is
  ...
  constant mode_vals : mode_array := (B"111", 
                                      B"111", 
                                      B"111", 
                                      B"111", 
                                      B"111");
                                      
  constant Zero_vals : Zero_array := ('0','0','0','1','0');
  
  constant OE_vals : OE_array := ('1','1','1','1','1');
  
  constant Cout_vals : Cout_array := ('1','1','1','0','1');
  
  constant C_vals : C_array := (B"1111_1111_1110_1111",
